...
namespace BSuit.API.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public TwoFactorAuthenticationModel(
            UserManager<BSuit.Identity.Models.ApplicationUser> userManager, SignInManager<BSuit.Identity.Models.ApplicationUser> signInManager, ILogger<TwoFactorAuthenticationModel> logger)
        {
